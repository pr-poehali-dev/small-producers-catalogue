...
function ProductModal({ product, manufacturer, onClose, onManufacturerClick }: {
  product: Product;
  manufacturer: Manufacturer;
  onClose: () => void;
  onManufacturerClick: (id: string) => void;
  ...
  return createPortal(
    ...
    >
      <div
        className="bg-card rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-scale-in"
      ...
      >
        ...
        <div className="p-5">
          ...
          <div className="border border-border rounded-xl p-4 mb-4">
            ...
            <button
              onClick={() => { onClose(); onManufacturerClick(manufacturer.id); }}
